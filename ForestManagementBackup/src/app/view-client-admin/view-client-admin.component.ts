...
@Component({
  selector: 'app-view-client-admin',
  templateUrl: './view-client-admin.component.html',
  styleUrls: ['./view-client-admin.component.css']
})
export class ViewClientAdminComponent implements OnInit {
  message: string;
  clients: Client[];
